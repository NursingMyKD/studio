...
export default function TopicInDepthDetailPage() {
  ...
  if (!item) {
    return (
      <div className="text-center py-20">
        ...
        <p className="text-muted-foreground mb-6">The requested topic details could not be found.</p>
        <Button asChild>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="mt-8 text-center">
        <Button variant="outline" onClick={() => router.push(`/topics/${slug}`)}>
          <ArrowLeft className="mr-2 h-4 w-4" /> Back to Overview
        </Button>
      </div>
    </div>
