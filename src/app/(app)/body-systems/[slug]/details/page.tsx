  ...
  if (!item) {
    return (
      <div className="text-center py-20">
        ...
        <p className="text-muted-foreground mb-6">The requested body system details could not be found.</p>
        <Button asChild>
    ...
    <div className="space-y-6">
      ...
      <Card className="shadow-lg">
       ...
       <div className="mt-8 text-center">
          <Button variant="outline" onClick={() => router.push(`/body-systems/${slug}`)}>
            <ArrowLeft className="mr-2 h-4 w-4" /> Back to Overview
          </Button>
        </div>
    </div>
